  ...
  <body>
    ...
    <main>
        <article class="leader">
            ...
            <p class="leader-copy"><span class="bold">CMA Items for Sale –</span>Long sleeve t-shirts, hats and backpacks are now <a href="support.php" class="info_link">available for purchase.</a></p> 
